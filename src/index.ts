  ...
  openAPISpecs(app, {
    documentation: {
      info: {
        title: 'EntryWise API',
        description:
          'Zalando Guidelines-compliant Form Backend-as-a-Service running globally on Cloudflare Workers.',
      ...
      tags: [
        {
          name: 'Submissions',
          description: 'Form submission ingestion and submission inbox management',
        },
        {
          name: 'Companies',
          description: 'Company account and email delivery provider configuration',
        },
        {
          name: 'Sites',
...
app.get('/f/:key', (c) =>
  c.text('EntryWise Form Ingestion Endpoint. Submit submissions via POST.', 405)
);
