...
fieldsRouter.post(
  '/:site_id/bulk',
  describeRoute(bulkCreateFieldDocs),
  validator('param', z.object({ site_id: z.string() })),
...
fieldsRouter.get(
  '/:site_id',
  describeRoute(getFieldsDocs),
  validator('param', z.object({ site_id: z.string() })),
  getFields
);
fieldsRouter.get(
  '/:site_id/:id',
  describeRoute(getFieldDocs),
  validator('param', z.object({ site_id: z.string(), id: z.string() })),
  getField
);
fieldsRouter.put(
  '/:site_id/:id',
  describeRoute(updateFieldDocs),
  validator('param', z.object({ site_id: z.string(), id: z.string() })),
...
fieldsRouter.delete(
  '/:field_id',
  describeRoute(deleteFieldDocs),
  validator('param', z.object({ field_id: z.string() })),
  deleteField
);
